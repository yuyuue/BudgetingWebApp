...
urlpatterns = [
    ...
    # path("<int:cash_flow_id>/mod-cash-flow", views.mod_cash_flow, name='mod_cash_flow'),
    ...
    # path("category/<int:cash_flow_category_id>/mod-cash-flow-category", views.mod_cash_flow_category, name='mod_cash_flow_category'),
    path("asset/", views.AssetListView.as_view(), name='asset'),
